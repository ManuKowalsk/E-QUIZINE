    ...
    <div class="container">
      <div class="row gy-4 d-flex justify-content-between">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <p data-aos="fade-up" data-aos-delay="100">Veuillez saisir le code du match si dessous puis cliquer sur rejoindre</p>
          ...
          <div class="row gy-4" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="col-lg-3 col-6">
              <div class="stats-item text-center w-100 h-100">
                ...
                <?php
                if(isset($match)) {
                echo("data-purecounter-end='$match->nb'");
                }
                ?> 
                data-purecounter-duration="1" class="purecounter"></span>
                <p>Matchs</p>
            ...
            <div class="col-lg-3 col-6">
              <div class="stats-item text-center w-100 h-100">
                ...
                <?php
                if(isset($player)) {
                echo("data-purecounter-end='$player->nb'");
                }
                ?> 
                data-purecounter-duration="1" class="purecounter"></span>
                <p>Joueurs</p>
            ...
            <div class="col-lg-3 col-6">
              <div class="stats-item text-center w-100 h-100">
                ...
                <?php
                if(isset($forma)) {
                echo("data-purecounter-end='$forma->nb'");
                }
                ?> 
                data-purecounter-duration="1" class="purecounter"></span>
                <p>Formateurs</p>
