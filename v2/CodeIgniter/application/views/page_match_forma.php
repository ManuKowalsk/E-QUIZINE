    ...
    <section id="service" class="services pt-0">
        <div class="container" data-aos="fade-up">
            <div class="section-header">
                                ...
                                if (!isset($traite[$a["qst_texte"]])) {
                                    ...
                                    foreach ($match as $mtc) {
                                        ...
                                        if (strcmp($mtc_id, $mtc["qst_texte"]) == 0) {
                                            //echo form_checkbox($mtc["rep_id"], $mtc["rep_correct"], FALSE);
                                            echo "<li>";
                ...
                $matchid = $match[0]["mtc_codematch"];

                if ($match != NULL) {
                    if ($match[0]["mtc_date_fin"] == NULL) {
                        echo validation_errors();
                        echo form_open('compte/terminer_match');
                        echo form_hidden('code', $matchid);
                        echo form_submit('mysubmit', 'Terminer le match');
                       
                        echo "</form>";
                    } else {
                        echo ("Le score final est : ");
                        echo ($match[0]['mtc_scoreactif']);
                        echo (" %");
                    }
                }
                ?>
